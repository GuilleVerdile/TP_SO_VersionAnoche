...
int idBuscar;
int socketProcEjecucionABuscar;
int idCPUBuscar;
int idGlobal;
int bloquearDT;
int idBanquero;
...
//pthread_mutex_t mutex_proc_ejecucion;
pthread_mutex_t  mutex_pcp;
pthread_mutex_t  mutex_idBuscar;
pthread_mutex_t  mutex_socketProcEjecucionABuscar;
pthread_mutex_t  mutex_cpuBuscar;
pthread_mutex_t mutex_recursoABuscar;
int flag_seEnvioSignalPlanificar;
int flag_quierenDesalojar;
int flag_replanificar ;
//
...
void* planificadorLargoPlazo(void* pathEscriptorioCPU);
...
bool verificarSiFinalizarElProcesoEnEjecucion(int quantum, int idProcesoEnExec);
